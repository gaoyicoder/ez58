...
<tr bgcolor="white">
    ...
    <td>
        <label for="1"><input class="radio" type="radio" value="1" name="if_share" <?php if($cat[if_share]=='1'){?>checked="checked"<?}?>>是</label>
        <label for="0"><input class="radio" type="radio" value="0" name="if_share" <?php if($cat[if_share]=='0'){?>checked="checked"<?}?>>否</label>
    </td>
</tr>
<tr bgcolor="white">
    <td width="15%" bgcolor="#F1F5F8">发布栏描述： </td>
    <td>
        <textarea name="share_desc"><?=$cat[share_desc]?></textarea>
    </td>
</tr>
<tr bgcolor="white">
    <td width="15%" bgcolor="#F1F5F8">查找栏描述： </td>
    <td>
        <textarea name="find_desc"><?=$cat[find_desc]?></textarea>
    </td>
</tr>
<tr bgcolor="white">
...
<tr bgcolor="white">
    ...
    <td>
        <label for="1"><input class="radio" onclick="show_single(1)" type="radio" value="1" <?php if($cat[time_type]=='1'){?>checked="checked"<?}?> name="time_type">单选</label>
        <label for="0"><input class="radio" onclick="show_single(0)" type="radio" value="0" name="time_type" <?php if($cat[time_type]=='0'){?>checked="checked"<?}?>>手动输入</label>
    </td>
</tr>
<tr id="single_select" <?php if($cat[time_type]=='0'){?>style="display: none;"<?}?> bgcolor="white">
...
<tr bgcolor="white">
    ...
    <td>
        <label for="1"><input class="radio" onclick="show_type_type(1)" type="radio" value="1" <?php if($cat[type_type]=='1'){?>checked="checked"<?}?> name="type_type">有</label>
        <label for="0"><input class="radio" onclick="show_type_type(0)" type="radio" value="0" <?php if($cat[type_type]=='0'){?>checked="checked"<?}?> name="type_type">无</label>
    </td>
</tr>
<tr id="type_type_select" <?php if($cat[type_type]=='0'){?>style="display: none;"<?}?> bgcolor="white">
