...
!in_array($mod,array('category','index','items','information','login','register','post','search','member','history','news','goods','corp','store','changecity','sync', 'sync_map', 'message', 'message_detail', 'cate_index', 'share_parking', 'find_parking', 'parking_map', 'parking_info', 'parking_book', 'parking_exchange')) && $mod = 'index';
